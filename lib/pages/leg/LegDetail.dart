...
class Legdetail extends StatefulWidget {
  final String title;
  ...
  const Legdetail({
    super.key,
    this.title = 'รองเท้า', // ให้ default แบบนี้ก็พอ
    required this.imagePath,
    required this.tabType,
  });

  @override
  State<Legdetail> createState() => _GlassesdetailState();
}


class _GlassesdetailState extends State<Legdetail> {
  int quantity = 1;
