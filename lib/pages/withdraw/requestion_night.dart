// หน้าเมนูหลัก (RequestionNight)
import 'package:flutter/material.dart';
import 'package:quikguardtrue/pages/sefty/seftyhome.dart';

class RequestionNight extends StatefulWidget {
  final String employeeId;
  const RequestionNight({super.key, required this.employeeId});

  @override
  _RequestionState createState() => _RequestionState();
}

class _RequestionState extends State<RequestionNight> {
  @override
