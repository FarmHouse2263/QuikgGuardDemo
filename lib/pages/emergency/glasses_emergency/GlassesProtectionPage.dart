...
import 'GlassesDetail.dart';
import '../../sefty/seftyhome.dart';

class Glassesprotectionpage extends StatefulWidget {
  final String employeeId;
  final String tabType; // "เบิกขาด" หรือ "เบิกคืน"

  const Glassesprotectionpage({super.key, required this.tabType, required this.employeeId});

  @override
  State<Glassesprotectionpage> createState() => _HeadprotectionState();
}

class _HeadprotectionState extends State<Glassesprotectionpage> {
