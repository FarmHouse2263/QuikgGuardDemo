...
import 'MaskDetail.dart';
import '../../sefty/seftyhome.dart';

class Maskprotectionpage extends StatefulWidget {
  final String employeeId;
  final String tabType; // "เบิกขาด" หรือ "เบิกคืน"

  const Maskprotectionpage({super.key, required this.tabType, required this.employeeId});

  @override
  State<Maskprotectionpage> createState() => _HeadprotectionState();
}

class _HeadprotectionState extends State<Maskprotectionpage> {
