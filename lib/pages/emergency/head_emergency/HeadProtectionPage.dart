...
class Headprotection extends StatefulWidget {
  final String employeeId;
  final String tabType; // "เบิกขาด" หรือ "เบิกคืน"

  const Headprotection({super.key, required this.tabType, required this.employeeId});

  @override
  State<Headprotection> createState() => _HeadprotectionState();
}

class _HeadprotectionState extends State<Headprotection> {
