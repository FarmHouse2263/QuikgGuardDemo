...
import 'SoundDetail.dart';

class Soundprotectionpage extends StatefulWidget {
  final String employeeId;
  final String tabType; // "เบิกขาด" หรือ "เบิกคืน"

  const Soundprotectionpage({super.key, required this.tabType, required this.employeeId});

  @override
  State<Soundprotectionpage> createState() => _HeadprotectionState();
}

class _HeadprotectionState extends State<Soundprotectionpage> {
