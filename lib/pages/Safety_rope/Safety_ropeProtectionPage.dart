...
import 'Safety_ropeDetail.dart';

class SafetyRopeprotectionpage extends StatefulWidget {
  final String employeeId;
  final String tabType; // "เบิกขาด" หรือ "เบิกคืน"

  const SafetyRopeprotectionpage({super.key, required this.tabType, required this.employeeId});

  @override
  State<SafetyRopeprotectionpage> createState() => _HeadprotectionState();
}

class _HeadprotectionState extends State<SafetyRopeprotectionpage> {
                      ...
                      return PPECard(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => SafetyRopedetail(
                                title: item['title'],
                                imagePath: item['image'],
