...
import 'safety_vestDetail.dart';

class SafetyVestprotectionpage extends StatefulWidget {
  final String employeeId;
  final String tabType; // "เบิกขาด" หรือ "เบิกคืน"

  const SafetyVestprotectionpage({super.key, required this.tabType, required this.employeeId});

  @override
  State<SafetyVestprotectionpage> createState() => _HeadprotectionState();
}

class _HeadprotectionState extends State<SafetyVestprotectionpage> {
                      ...
                      return PPECard(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => SafetyVestdetail(
                                title: item['title'],
                                imagePath: item['image'],
                  ...
                  child: Center(
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => SecurityGuard(employeeId: widget.employeeId)),
                        );
                      },
                    ),
                  ),
