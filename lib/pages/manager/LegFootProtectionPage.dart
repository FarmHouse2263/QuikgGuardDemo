...
class LegFootProtectionPage extends StatefulWidget {
  const LegFootProtectionPage({super.key});

  @override
  State<LegFootProtectionPage> createState() => _LegFootProtectionPageState();
}

class _LegFootProtectionPageState extends State<LegFootProtectionPage> {
  List<bool> selected = [];
