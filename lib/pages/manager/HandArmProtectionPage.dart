...
class HandArmProtectionPage extends StatefulWidget {
  const HandArmProtectionPage({super.key});

  @override
  State<HandArmProtectionPage> createState() => _HandArmProtectionPageState();
}

class _HandArmProtectionPageState extends State<HandArmProtectionPage> {
  List<bool> selected = [];
