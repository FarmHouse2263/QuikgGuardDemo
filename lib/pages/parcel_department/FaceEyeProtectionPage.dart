...
class FaceEyeProtectionPage extends StatefulWidget {
  const FaceEyeProtectionPage({super.key});

  @override
  State<FaceEyeProtectionPage> createState() => _FaceEyeProtectionPageState();
}

class _FaceEyeProtectionPageState extends State<FaceEyeProtectionPage> {
  List<bool> selected = [];
